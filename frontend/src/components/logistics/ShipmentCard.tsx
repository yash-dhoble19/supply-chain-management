...
export function ShipmentCard({ shipment, onTrack, onStart, onDelete, isStarting, isDeleting, isActive }: ShipmentCardProps) {
  return (
    <article
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            disabled={isDeleting}
            className="inline-flex items-center justify-center rounded-full border border-red-200 bg-red-50 px-4 py-2.5 text-sm font-semibold text-red-700 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:border-red-100 disabled:text-red-400"
          >
