    ...
    <div className="min-h-screen bg-background text-on-surface">
      ...
      <main className="min-h-screen lg:ml-[240px]">
        <Header
          ...
          searchPlaceholder="Search POs, SKU, or Suppliers..."
          showRefresh={false}
          showHelp
        />
            ...
            <div className="space-y-6 lg:col-span-8">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex gap-4 border-b border-outline-variant/30">
                  <button className="border-b-2 border-primary px-1 pb-2 text-sm font-bold text-primary">
                    Performance Analytics
                  </button>
                  <button className="px-1 pb-2 text-sm font-medium text-on-surface-variant hover:text-on-surface">
                    Manage Suppliers
                  </button>
                </div>
              </div>
      ...
      <button className="fixed bottom-8 right-8 flex h-14 w-14 items-center justify-center rounded-full bg-kinetic text-white shadow-2xl transition-transform hover:scale-105">
